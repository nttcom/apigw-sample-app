...
###*
 # @ngdoc function
 # @name nttcomApiGatewayWebappApp.controller:ContractGroupCtrl
 # @description
 # # ContractGroupCtrl
 # Controller of the nttcomApiGatewayWebappApp
###
angular.module 'nttcomApiGatewayWebappApp'
  .controller 'ContractGroupCtrl',
  [ '$scope', '$routeParams', '$location', '$anchorScroll', 'contractStore', 'serviceFactory', 'vpnGroupFilter',
  class ContractGroupCtrl

    constructor: (@$scope, @$routeParams, @$location, @$anchorScroll, @contractStore, @serviceFactory, @vpnGroupFilter) ->
