...
pidfile "#{ENV['PWD']}/tmp/puma.pid"

# Use "path" as the file to store the server info state. This is
# used by "pumactl" to query and control the server.
#
# state_path '/u/apps/lolcat/tmp/pids/puma.state'
state_path "#{ENV['PWD']}/tmp/puma.state"
...
stdout_redirect "#{ENV['PWD']}/log/puma.stdout.log", "#{ENV['PWD']}/log/puma.stderr.log"
...
bind "unix://#{ENV['PWD']}/tmp/puma.socket"
